...
class PurePursuitController:
    def __init__(self):
        self.lookahead_distance = 1.0  # 预瞄距离，可以根据需要调整
        self.max_steering_angle = np.pi / 3  # 最大转向角
    ...
    def find_target_point(self):
        ...
        distances = [self.get_distance((x, y), point) for point in self.path]
    ...
    def compute_control(self):
        ...
        ackermann_cmd.drive.speed = 1.0  # 固定速度
